...
import clids.ex5.crosswords.Crossword;
import clids.ex5.crosswords.CrosswordEntry;
import clids.ex5.crosswords.CrosswordDictionary;
import clids.ex5.crosswords.CrosswordPosition;
import clids.ex5.crosswords.CrosswordStructure;
import clids.ex5.crosswords.MyCrossword;
import clids.ex5.crosswords.MyCrosswordDictionary;
import clids.ex5.crosswords.MyCrosswordStructure;
import clids.ex5.crosswords.CrosswordStructure.SlotType;
import clids.ex5.search.*;
...
public class CrosswordViewer extends JFrame implements ActionListener,
	...
	public void setupCrossword(String structureFileName, String dictionaryFileName,
			long timeout) throws IOException {
		/** CODE CONNECTION **/
		 // Loading structure and dictionary
	...
	private class InternalCrosswordPosition implements CrosswordPosition {
		...
		/* (non-Javadoc)
		 * @see clids.ex5.crosswords.CrosswordPosition#getX()
		 */
		public int getX() {
			return _x;
		}
		...
		/* (non-Javadoc)
		 * @see clids.ex5.crosswords.CrosswordPosition#getY()
		 */
		public int getY() {
			return _y;
		}
		/* (non-Javadoc)
		 * @see clids.ex5.crosswords.CrosswordPosition#isVertical()
		 */
